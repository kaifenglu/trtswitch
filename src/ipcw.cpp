...
List ipcwcpp(
  ...
  if (k > 0) {
    ...
    NumericMatrix zn_cox_den1(n+k, zn_cox_den.ncol());
    NumericMatrix zn_lgs_den1(n+k, zn_lgs_den.ncol());
    for (i=0; i<n; i++) {
      zn1(i,_) = zn(i,_);
      zn_cox_den1(i,_) = zn_cox_den(i,_);
    ...
    for (i=0; i<k; i++) {
      ...
      zn1(n+i,_) = zn(l,_);
      zn_cox_den1(n+i,_) = zn_cox_den(l,_);
  ...
  auto f = [&k, data, has_stratum, stratum, p_stratum, u_stratum, 
            ...
            swtrt_control_only, alpha, zcrit, ties](
                ...
                NumericMatrix& zb_lgs_den)->List {
                  ...
                  // exclude observations after treatment switch for ipcw
